...
INSERT INTO `admin_group_permission_tbl` (`admin_group_id`, `security_token`) VALUES (4,'action.getcustomer'),(4,'action.op.ActivateDoubleOptIn'),(4,'action.op.ExecuteScript'),(4,'action.op.GetArchiveList'),(4,'action.op.GetArchiveMailing'),(4,'action.op.GetCustomer'),(4,'action.op.SendMailing'),(4,'action.op.ServiceMail'),(4,'action.op.SubscribeCustomer'),(4,'action.op.UnsubscribeCustomer'),(4,'action.op.UpdateCustomer'),(4,'actions.change'),(4,'actions.delete'),(4,'actions.set_usage'),(4,'actions.show'),(4,'admin.change'),(4,'admin.delete'),(4,'admin.new'),(4,'admin.show'),(4,'adminlog.show'),(4,'blacklist'),(4,'campaign.change'),(4,'campaign.delete'),(4,'campaign.new'),(4,'campaign.show'),(4,'campaign.stat'),(4,'charset.use.gb2312'),(4,'charset.use.iso_8859_1'),(4,'charset.use.iso_8859_15'),(4,'charset.use.utf_8'),(4,'cms.central_content_management'),(4,'cms.mailing_content_management'),(4,'forms.change'),(4,'forms.delete'),(4,'forms.view'),(4,'import.mode.add'),(4,'import.mode.add_update'),(4,'import.mode.blacklist'),(4,'import.mode.bounce'),(4,'import.mode.doublechecking'),(4,'import.mode.null_values'),(4,'import.mode.only_update'),(4,'import.mode.remove_status'),(4,'import.mode.unsubscribe'),(4,'mailing.archived'),(4,'mailing.attachments.show'),(4,'mailing.change'),(4,'mailing.components.change'),(4,'mailing.components.show'),(4,'mailing.content.show'),(4,'mailing.copy'),(4,'mailing.default_action'),(4,'mailing.delete'),(4,'mailing.graphics_upload'),(4,'mailing.new'),(4,'mailing.send.admin'),(4,'mailing.send.admin.options'),(4,'mailing.send.show'),(4,'mailing.send.test'),(4,'mailing.send.world'),(4,'mailing.show'),(4,'mailing.show.charsets'),(4,'mailing.show.types'),(4,'mailinglist.change'),(4,'mailinglist.delete'),(4,'mailinglist.new'),(4,'mailinglist.show'),(4,'mailinglist.recipients.delete'),(4,'mailloop.change'),(4,'mailloop.delete'),(4,'pluginmanager.show'),(4,'profileField.show'),(4,'recipient.change'),(4,'recipient.delete'),(4,'recipient.new'),(4,'recipient.show'),(4,'recipient.view'),(4,'settings.show'),(4,'stats.clean'),(4,'stats.domains'),(4,'stats.ip'),(4,'stats.mailing'),(4,'stats.rdir'),(4,'targets.change'),(4,'targets.createml'),(4,'targets.delete'),(4,'targets.show'),(4,'template.change'),(4,'template.components.show'),(4,'template.delete'),(4,'template.new'),(4,'template.show'),(4,'update.show'),(4,'use_charset_iso_8859_1'),(4,'userlog.show'),(4,'wizard.export'),(4,'wizard.import'),(4, 'recipient.column.select');
...
INSERT INTO `customer_1_tbl` (`customer_id`, `email`, `gender`, `mailtype`, `firstname`, `lastname`, `creation_date`, `change_date`, `title`, `datasource_id`) VALUES (1,'first.last@domain.org',0,1,'First','Last',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,NULL,0),(2,'no.name@yourdomain.com',0,1,'No','Name',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,NULL,0);
